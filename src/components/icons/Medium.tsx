  ...
  return (
    <span
      className="w-[44px] h-[44px] rounded-[10px] bg-gray-200 flex items-center justify-center
                hover:bg-black hover:text-white cursor-pointer [&_path]:fill-black [&:hover_path]:fill-white"
    >
      <svg
        width="24"
        height="14"
      ...
      >
        ...
        <path d="M24 7.00056C24 10.1744 23.467 12.7482 22.81 12.7482C22.1531 12.7482 21.6201 10.1754 21.6201 7.00056C21.6201 3.82576 22.1531 1.25293 22.81 1.25293C23.467 1.25293 24 3.82676 24 7.00056Z" />
      </svg>
    </span>
  );
}
